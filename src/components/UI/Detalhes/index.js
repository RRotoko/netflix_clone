...
export const DescriptionHighlight = styled(DescriptionContainer)`
    width: inherit;
    height: inherit;
...
export const Overview = styled.div`
    ...
    overflow-y: hidden;
    text-overflow: ellipsis; /* Pridanie „...“ na koniec*/
    display: -webkit-box;
    -webkit-line-clamp: 5; /*počet riadkov*/
...
export const ButtonsDetails = styled.a`
    display: inline-block;
    font-size: 20px;
    font-weight: bold;
    padding: 8px 20px;
